                ...
                <div className='w-full'>
                    ...
                    <div id="bottom" className='py-3 md:py-6 px-4 md:px-24 border-t border-gray-300 border-dashed'>
                        ...
                        <div className="flex items-center justify-between mt-6">
                            <button className='text-favblue font-roboto border border-favblue py-[7px] rounded-lg hover:bg-favblue hover:text-white basis-[45%]'>Prev</button>
                            <button className='text-white font-semibold bg-favblue py-2 rounded-lg hover:opacity-90  basis-[45%]'>Make Payment</button>
                        </div>
                    </div>
                </div>
            </ContentSwitcher>
