  ...
  return (
    <div className='pb-32 pt-[5.5rem] md:pt-28'>
		...
		<div className='flex flex-col w-[90%] md:w-4/5 lg:w-3/5 mx-auto gap-5'>
			<button 
				className="bg-red bg-opacity-90 text-white max-w-fit px-5 py-[0.375rem] rounded-lg ms-auto active:bg-opacity-100"
				onClick={deleteAll}
			>Delete All <i className="bi bi-trash-fill"></i></button>
			{ticks.map((ticket, idx) => (
				<div 
